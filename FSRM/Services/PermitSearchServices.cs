...
namespace FSRM.Services
{
    public class PermitSearchServices
    {
        ...
        public List<AdminUserPermitsViewModel> Report(string ReqSData, string ReqEData, string AppSData, string AppEData, string[] ch_Access,
            string[] ch_Types, string Owner, string OU_ID, string PersonelName, string PersonelNo, string FolderAddress, string AdminName)
        //public void Report(string ReqSData, string ReqEData, string AppSData, string AppEData, string[] ch_Access, string Owner, string OU_ID) 
        {
            ...
            var ReportsFolder = new List<AdminUserPermitsViewModel>();
            ...
            #region فیلتر بر اساس تاریخ بررسی مدیر  --  ReportsDate
            ...
            #region فیلتر بر اساس نوع دسترسی --  ReportsPerms
            ...
            #region فیلتر بر اساس نام فولدر   --  ReportsFolder

            if (FolderAddress == "")
            {
                ReportsFolder = ReportsPerms;
            }
            else
            {
                foreach (var item in ReportsPerms)
                {
                    if (item.FolderAddress.ToLower().Contains(FolderAddress.ToLower()))
                    {
