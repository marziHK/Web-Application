...
namespace FSRM.Models
{
    public class FolderSearchData
    {
        ...
        #region بدون اعمال نام مدیر سیستم 
        public List<AdminUserFolderViewModel> ReportByRequestDates_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
                ...
                var sss = db.Tbl_FoldersRequestLog.Where(e => e.fld_FK_FoldersID == 5)
                                         .Where(e => e.fld_FolderRequestLog_PersonModified.Contains(AdminName))
                                            .Count();
                ...
                var q = (from l in db.Tbl_FoldersRequestLog
                         ...
                         where
                           ...
                           db.Tbl_FoldersRequestLog.Where(e => e.fld_FK_FoldersID == f.fld_FolderID)
                                         .Where(e => e.fld_FolderRequestLog_PersonModified.Contains(AdminName))
                                            .Count()
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_1r_Open_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_1r_Closed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_1r_Refused_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_1r_Removed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_2r_Open_Closed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_2r_Open_Refused_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_2r_Open_Removed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_2r_Closed_Refused_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_2r_Closed_Removed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_2r_Removed_Refused_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_3r_Open_Closed_Refused_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_3r_Open_Closed_Removed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_3r_Open_Refused_Removed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_3r_Closed_Refused_Removed_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
        ...
        public List<AdminUserFolderViewModel> ReportByRequestDates_4r_AllRequestType_AdminName(int ReqSData, int ReqEData, string AdminName)
        {
            try
            {
                db = new db_FSRMEntities();
