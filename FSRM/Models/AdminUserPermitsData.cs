    ...
    public class AdminUserPermitsData
    {
        ...
        public string AdminChecked(int AccessID, string HDate, string HTime, DateTime MDate, string AdminName)
        {
            try
            {
                ...
                DB.SaveChanges();
                string OwnerEmail = DB.Tbl_FoldersOwner.Where(x => x.fld_FolderOwnerID == (DB.Tbl_Folders.Where(z => z.fld_FolderID == q.fld_FK_FolderID).Select(z => z.fld_FK_FolderOwner).FirstOrDefault())).Select(x => x.fld_FolderOwnerEmail).FirstOrDefault().ToString();
        ...
        public string UpdateUserPermits_ByAdmin(AdminUserPermitsViewModel model, string AdminName, int HDate, string HTime, DateTime dt)
        {
            try
            {
                ...
                string OwnerEmail = DB.Tbl_FoldersOwner.Where(x => x.fld_FolderOwnerID == (DB.Tbl_Folders.Where(z => z.fld_FolderID == a.fld_FK_FolderID).Select(z => z.fld_FK_FolderOwner).FirstOrDefault())).Select(x => x.fld_FolderOwnerEmail).FirstOrDefault().ToString();
       ...
       // سلب دسترسی بعد از اختصاص
        public string RemoveUserPermit_ByAdmin(int AccessID, string HDate, string HTime, DateTime MDate, string AdminName)
        {
            try
            {
                ...
                DB.SaveChanges();
                string OwnerEmail = DB.Tbl_FoldersOwner.Where(x => x.fld_FolderOwnerID == (DB.Tbl_Folders.Where(z => z.fld_FolderID == ac.fld_FK_FolderID).Select(z => z.fld_FK_FolderOwner).FirstOrDefault())).Select(x => x.fld_FolderOwnerEmail).FirstOrDefault().ToString();
        ...
        public string RemoveUserPermitsRequest_ByAdmin(AdminUserPermitsViewModel model, string AdminName, int HDate, string HTime, DateTime dt)
        {
            try
            {
                ...
                string OwnerEmail = DB.Tbl_FoldersOwner.Where(x => x.fld_FolderOwnerID == (DB.Tbl_Folders.Where(z => z.fld_FolderID == model.FolderID).Select(z => z.fld_FK_FolderOwner).FirstOrDefault())).Select(x => x.fld_FolderOwnerEmail).FirstOrDefault().ToString();
        ...
        public string RemovePermits_UserRequst(int AccID, string AdminName, int HDate, string HTime, DateTime dt)
        {
            try
            {
                ...
                string OwnerEmail = DB.Tbl_FoldersOwner.Where(x => x.fld_FolderOwnerID == (DB.Tbl_Folders.Where(z => z.fld_FolderID == (DB.Tbl_Access.Where(o=>o.fld_AccessID == AccID).Select(o=>o.fld_FK_FolderID).FirstOrDefault())
