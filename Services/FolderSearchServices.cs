...
namespace FSRM.Services
{
    public class FolderSearchServices
    {
        ...
        public List<AdminUserFolderViewModel> Report(string ReqSData, string ReqEData, string AppSData, string AppEData, string[] ch_Types, string Owner, string OU_ID, string ApprovedValue)
